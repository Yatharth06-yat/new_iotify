...
import {
  ...
  ChevronDown, Users, FlaskConical, GraduationCap, Youtube
} from "lucide-react";
                ...
                >
                  {info.href ? (
                    <a
                      ...
                      className="flex items-center gap-4 p-5 rounded-2xl transition-all duration-250 hover:border-accent/40"
                      style={{ background: "#FFFFFF", border: "1px solid rgba(17,24,39,0.09)", boxShadow: "0 1px 4px rgba(17,24,39,0.04)" }}
                    >
                      {CardContent}
                    </a>
