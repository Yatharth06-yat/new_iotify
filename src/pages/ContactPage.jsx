    ...
    >
      ...
      >
        <div
          ...
          style={{ borderTop: "1px solid rgba(17,24,39,0.07)", paddingTop: "14px" }}
        >
          {a}
        </div>
      </motion.div>
...
export default function ContactPage() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "iotily@mits.ac.in", sub: "Response within 24 hours", href: "mailto:iotily@mits.ac.in" },
    { icon: Youtube, label: "YouTube", value: "IoTify Lab MITS", sub: "Watch lab tutorials & demos", href: "https://youtube.com/@iotifylabmits?si=v3H9LDrcABtWdb4O" },
  ...
  return (
    <div className="page-enter" style={{ background: "#FFF2E5" }}>
        ...
        <div className="mx-auto max-w-2xl relative z-10 pt-20">
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }}>
            ...
            <h1 className="font-extrabold text-4xl sm:text-5xl lg:text-6xl text-gray-900 leading-[1.06] tracking-tight mb-5">
              Connect with <span className="text-accent">CIoT MITS</span>
            </h1>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div className="flex flex-col gap-1.5">
                          <label htmlFor="contact-name" className="text-xs font-semibold text-gray-700 tracking-wide">
                            Full Name *
                          </label>
                          <input
                            id="contact-name"
                        ...
                        <div className="flex flex-col gap-1.5">
                          <label htmlFor="contact-email" className="text-xs font-semibold text-gray-700 tracking-wide">
                            Email *
                          </label>
                          <input
                            id="contact-email"
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="contact-subject" className="text-xs font-semibold text-gray-700 tracking-wide">
                          Subject
                        </label>
                        <select
                          id="contact-subject"
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="contact-message" className="text-xs font-semibold text-gray-700 tracking-wide">
                          Message *
                        </label>
                        <textarea
                          id="contact-message"
      ...
      {/* ── FAQs ── */}
      <section
        className="relative px-6 py-14 lg:py-20"
        style={{ background: "#FAECE1", borderTop: "1px solid rgba(17,24,39,0.08)" }}
      >
