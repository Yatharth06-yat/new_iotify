...
import { ArrowRight, ChevronDown, GraduationCap, Award, Users, Youtube } from "lucide-react";
    ...
    >
      ...
      <div className="mx-auto max-w-7xl w-full px-5 sm:px-6 grid grid-cols-1 lg:grid-cols-[54%_46%] gap-12 lg:gap-16 items-center relative z-10">
        ...
        >
          ...
          <motion.p
            variants={stagger.item}
            className="text-justify text-gray-600 text-sm sm:text-base leading-relaxed max-w-[520px] mb-10"
          >
